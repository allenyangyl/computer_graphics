...
class BVHAccel : public Aggregate {
 public:
  ...
  void newNode(BVHNode*& root, const std::vector<Primitive*>& primitives, size_t start, size_t range, size_t max_leaf_size);
  ...
  bool closestHit(const BVHNode* root, const Ray &ray, Intersection* isect) const;
